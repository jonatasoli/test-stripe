...
const activePanel = ref('none' | 'search' | 'languages' | 'activity' | 'task')
    ...
    <Sidebar :theme="props.theme" :is-open="isDesktopSidebarOpen">
      ...
      <template #bottom-links>
        ...
        <li class="right-panel-trigger is-hidden-touch">
          <a aria-label="Display search panel" data-content="Search" @click="activePanel = 'search'">
            <i aria-hidden="true" class="iconify sidebar-svg" data-icon="feather-search" />
          </a>
          <a aria-label="Close all panels" class="is-hidden is-inactive" @click="activePanel = 'none'">
      ...
      <div class="page-content-wrapper">
        ...
        <div v-else class="page-content is-relative">
          <div class="page-title has-text-centered">
            <!-- Sidebar Trigger -->
            <div class="vuero-hamburger nav-trigger push-resize" @click="isDesktopSidebarOpen = !isDesktopSidebarOpen">

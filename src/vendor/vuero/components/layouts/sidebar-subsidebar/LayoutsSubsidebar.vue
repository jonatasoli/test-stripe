    ...
    <div class="inner" data-simplebar>
      <ul>
        ...
        <li v-has-nested-router-link class="has-children">
          ...
          <ul>
            <li>
              <RouterLink :to="{ name: 'sidebar-layouts-list-datatable-1' }" class="is-submenu">
                <i aria-hidden="true" class="lnil lnil-layout-alt"></i>
                <span>Datatable V1</span>
              </RouterLink>
            </li>
            <li>
              <RouterLink :to="{ name: 'sidebar-layouts-list-datatable-2' }" class="is-submenu">
                <i aria-hidden="true" class="lnil lnil-layout-alt"></i>
                <span>Datatable V2</span>
              </RouterLink>
            </li>
            <li>
              <RouterLink :to="{ name: 'sidebar-layouts-list-datatable-3' }" class="is-submenu">
                <i aria-hidden="true" class="lnil lnil-layout-alt"></i>
                <span>Datatable V3</span>
              </RouterLink>
            </li>
            <li>
              <RouterLink :to="{ name: 'sidebar-layouts-list-datatable-4' }" class="is-submenu">
                <i aria-hidden="true" class="lnil lnil-layout-alt"></i>
        ...
        <li v-has-nested-router-link class="has-children">
          ...
          <ul>
            ...
            <li>
              <RouterLink :to="{ name: 'sidebar-layouts-profile-notifications' }" class="is-submenu">
                <i aria-hidden="true" class="lnil lnil-notification"></i>
                <span>Notifications</span>
              </RouterLink>
            </li>
            <li>
              <RouterLink :to="{ name: 'sidebar-layouts-profile-settings' }" class="is-submenu">
        ...
        <li v-has-nested-router-link class="has-children">
          ...
          <ul>
            <li>
              <RouterLink :to="{ name: 'sidebar-layouts-projects-projects-1' }" class="is-submenu">
                <i aria-hidden="true" class="lnil lnil-grid-alt"></i>
                <span>Projects V1</span>
              </RouterLink>
            </li>
            <li>
              <RouterLink :to="{ name: 'sidebar-layouts-projects-projects-2' }" class="is-submenu">
                <i aria-hidden="true" class="lnil lnil-grid-alt"></i>
                <span>Projects V2</span>
              </RouterLink>
            </li>
            <li>
              <RouterLink :to="{ name: 'sidebar-layouts-projects-projects-3' }" class="is-submenu">
                <i aria-hidden="true" class="lnil lnil-grid-alt"></i>
                <span>Projects V3</span>
              </RouterLink>
            </li>
            <li>
              <RouterLink :to="{ name: 'sidebar-layouts-projects-details' }" class="is-submenu">
        ...
        <li v-has-nested-router-link class="has-children">
          ...
          <ul>
            <li>
              <RouterLink :to="{ name: 'sidebar-layouts-utility-account-confirm' }" class="is-submenu">
                <i aria-hidden="true" class="lnil lnil-thunderbolt"></i>
                <span>Confirm Account</span>
              </RouterLink>
            </li>
            <li>
              <RouterLink :to="{ name: 'sidebar-layouts-utility-promotion' }" class="is-submenu">
                <i aria-hidden="true" class="lnil lnil-magnet"></i>
                <span>Promotion Page</span>
              </RouterLink>
            </li>
            <li>
              <RouterLink :to="{ name: 'sidebar-layouts-utility-invoice' }" class="is-submenu">
        ...
        <li v-has-nested-router-link class="has-children">
          ...
          <ul>
            <li>
              <RouterLink :to="{ name: 'sidebar-layouts-onboarding-welcome' }" class="is-submenu">
                <i aria-hidden="true" class="lnil lnil-door-alt"></i>
                <span>Onboarding Welcome</span>
              </RouterLink>
            </li>
            <li>
              <RouterLink :to="{ name: 'sidebar-layouts-onboarding-page-1' }" class="is-submenu">
                <i aria-hidden="true" class="lnil lnil-train"></i>
                <span>Onboarding V1</span>
              </RouterLink>
            </li>
            <li>
              <RouterLink :to="{ name: 'sidebar-layouts-onboarding-page-2' }" class="is-submenu">
                <i aria-hidden="true" class="lnil lnil-train-alt"></i>
                <span>Onboarding V2</span>
              </RouterLink>
            </li>
            <li>
              <RouterLink :to="{ name: 'sidebar-layouts-onboarding-page-3' }" class="is-submenu">
                <i aria-hidden="true" class="lnil lnil-car"></i>
                <span>Onboarding V3</span>
              </RouterLink>
            </li>
            <li>
              <RouterLink :to="{ name: 'sidebar-layouts-onboarding-page-4' }" class="is-submenu">
                <i aria-hidden="true" class="lnil lnil-car-alt"></i>
                <span>Onboarding V4</span>
              </RouterLink>
            </li>
            <li>
              <RouterLink :to="{ name: 'sidebar-layouts-onboarding-page-5' }" class="is-submenu">
                <i aria-hidden="true" class="lnil lnil-train"></i>

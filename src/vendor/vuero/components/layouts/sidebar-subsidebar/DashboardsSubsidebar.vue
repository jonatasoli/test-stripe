      ...
      <ul>
        ...
        <li v-has-nested-router-link class="has-children">
          ...
          <ul>
            ...
            <li>
              <RouterLink :to="{ name: 'sidebar-dashboards-human-ressources' }" class="is-submenu">
        ...
        <li v-has-nested-router-link class="has-children">
          ...
          <ul>
            <li>
              <RouterLink :to="{ name: 'sidebar-dashboards-food-delivery' }" class="is-submenu">
        ...
        <li v-has-nested-router-link class="has-children">
          ...
          <ul>
            ...
            <li>
              <RouterLink class="is-submenu" :to="{ name: 'sidebar-dashboards-charts-billboardsjs' }">
        ...
        <li v-has-nested-router-link class="has-children">
          ...
          <ul>
            <li>
              <RouterLink :to="{ name: 'sidebar-dashboards-widgets-sample-ui' }" class="is-submenu">
                <i aria-hidden="true" class="lnil lnil-layout-alt-1"></i>
                <span>UI Widgets</span>
              </RouterLink>
            </li>
            <li>
              <RouterLink class="is-submenu" :to="{ name: 'sidebar-dashboards-widgets-sample-creative' }">
                <i aria-hidden="true" class="lnil lnil-layout-alt-2"></i>
                <span>Creative Widgets</span>
              </RouterLink>
            </li>
            <li>
              <RouterLink :to="{ name: 'sidebar-dashboards-widgets-sample-list' }" class="is-submenu">
                <i aria-hidden="true" class="lnil lnil-layout-alt-1"></i>
                <span>List Widgets</span>
              </RouterLink>
            </li>
            <li>
              <RouterLink :to="{ name: 'sidebar-dashboards-widgets-sample-stats' }" class="is-submenu">
                <i aria-hidden="true" class="lnil lnil-layout-alt-2"></i>

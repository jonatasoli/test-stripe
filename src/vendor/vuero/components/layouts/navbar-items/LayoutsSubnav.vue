...
<template>
  <div class="navbar-subnavbar-inner tabs-wrapper">
    ...
    <div class="container">
      ...
      <div id="grid-pages-tab" class="tab-content" :class="[activeTab === 'grid' && 'is-active']">
        <div class="tab-content-inner">
          <div class="center has-slimscroll">
            <div class="columns">
              <div class="column is-3">
      ...
      <div id="app-pages-tab" class="tab-content" :class="[activeTab === 'app' && 'is-active']">
        <div class="tab-content-inner">
          <div class="center has-slimscroll">
            <div class="columns">
              <div class="column is-3">
      ...
      <div id="utility-pages-tab" class="tab-content" :class="[activeTab === 'utility' && 'is-active']">
        <div class="tab-content-inner">
          <div class="center has-slimscroll">
            <div class="columns">
              <div class="column is-3">

  ...
  <div class="mobile-subsidebar is-activity">
    <div class="inner">
      ...
      <ul class="submenu">
        ...
        <li>
          <RouterLink :to="{ name: 'components-avatar-stack' }"> VAvatarStack </RouterLink>
        </li>
        <li>
        ...
        <li>
          <RouterLink :to="{ name: 'components-flex' }"> VFlex <small>& VFlexItem</small> </RouterLink>
        </li>
        <li>
          <RouterLink :to="{ name: 'components-grid' }"> VGrid <small>& VGridItem</small> </RouterLink>
        </li>
        <li>
        ...
        <li>
          <RouterLink :to="{ name: 'components-flex-pagination' }"> VFlexPagination </RouterLink>
        </li>
        <li v-has-nested-router-link class="has-children">
          ...
          <ul>
            ...
            <li>
              <RouterLink :to="{ name: 'components-flex-table-compact' }" class="is-submenu">
                <i aria-hidden="true" class="iconify" data-icon="feather:circle"></i>
                Compact Table
              </RouterLink>
            </li>
            <li>
              <RouterLink :to="{ name: 'components-flex-table-media' }" class="is-submenu">
                <i aria-hidden="true" class="iconify" data-icon="feather:circle"></i>
                Media Table
              </RouterLink>
            </li>
            <li>
              <RouterLink :to="{ name: 'components-flex-table-advanced' }" class="is-submenu">
                <i aria-hidden="true" class="iconify" data-icon="feather:circle"></i>
        ...
        <li v-has-nested-router-link class="has-children">
          ...
          <ul>
            ...
            <li>
              <RouterLink :to="{ name: 'components-plugins-billboard-js' }" class="is-submenu">
                <i aria-hidden="true" class="iconify" data-icon="feather:circle"></i>
                VBillboardJS
              </RouterLink>
            </li>
            <li>
              <RouterLink :to="{ name: 'components-plugins-photos-swipe' }" class="is-submenu">
                <i aria-hidden="true" class="iconify" data-icon="feather:circle"></i>
                VPhotosSwipe
              </RouterLink>
            </li>
            ...
            <li>
              <RouterLink :to="{ name: 'components-plugins-simple-datatables' }" class="is-submenu">
                <i aria-hidden="true" class="iconify" data-icon="feather:circle"></i>
                VSimpleDatatables
              </RouterLink>
            </li>

      ...
      <ul class="submenu">
        ...
        <li v-has-nested-router-link class="has-children">
          ...
          <ul>
            ...
            <li>
              <RouterLink :to="{ name: 'elements-icons-line-icons-regular' }" class="is-submenu">
                <i aria-hidden="true" class="iconify" data-icon="feather:circle"></i>
                Line Icons Regular
              </RouterLink>
            </li>
        ...
        <li>
          <RouterLink :to="{ name: 'elements-placeload-text' }">VPlaceloadText</RouterLink>
        </li>
        <li>
          <RouterLink :to="{ name: 'elements-placeload-avatar' }">VPlaceloadAvatar</RouterLink>
        </li>
        <li>
        ...
        <li v-has-nested-router-link class="has-children">
          ...
          <ul>
            <li>
              <RouterLink :to="{ name: 'elements-button' }" class="is-submenu"> VButton </RouterLink>
            </li>
            <li>
              <RouterLink :to="{ name: 'elements-action' }" class="is-submenu"> VAction </RouterLink>
            </li>
            <li>
              <RouterLink :to="{ name: 'elements-icon-button' }" class="is-submenu"> VIconButton </RouterLink>
            </li>
          </ul>
        </li>
        <li v-has-nested-router-link class="has-children">
          ...
          <ul>
            ...
            <li>
              <RouterLink :to="{ name: 'elements-control' }" class="is-submenu"> VControl </RouterLink>
            </li>
            <li>
              <RouterLink :to="{ name: 'elements-field' }" class="is-submenu"> VField </RouterLink>
            </li>
          </ul>
        </li>
        <li v-has-nested-router-link class="has-children">
        ...
        <li v-has-nested-router-link class="has-children">
          ...
          <ul>
            ...
            <li>
              <RouterLink :to="{ name: 'elements-addons-vueform-multiselect' }" class="is-submenu">
                <i aria-hidden="true" class="iconify" data-icon="feather:circle"></i>
                @vueform/multiselect
              </RouterLink>
            </li>

...
const totalDemos =
  sidebarDemos.length + authDemos.length + minimalDemos.length + templatesDemos.length + navbarDemos.length
  ...
  <div class="vuero-demos">
    ...
    <div v-if="totalResults === 0">
      ...
      >
        ...
        <template #action>
          <VButton :href="generateFeatureRequestLink(filterInput)" target="_blank" icon="feather:github">
    ...
    <div v-if="sidebarDemosFiltered.length > 0" class="demo-section">
      <div class="demo-section-title">
        <img class="light-image-block-l" src="/images/icons/components/layout-1.svg" alt="" />
        <img class="dark-image-block-l" src="/images/icons/components/layout-1-dark.svg" alt="" />
      ...
      <div class="columns is-multiline">
        <!-- Demo item -->
        <div v-for="(item, index) in sidebarDemosFiltered" :key="index" class="column is-4 has-text-centered">
          <figure class="vuero-demo-wrapper loaded">
            <span v-if="item.new" class="new-tag">New</span>
            <img class="light-image-block-l" :src="item.screenshot.light" alt="" loading="lazy" />
            <img class="dark-image-block-l" :src="item.screenshot.dark" alt="" loading="lazy" />
    ...
    <div v-if="navbarDemosFiltered.length > 0" class="demo-section">
      <div class="demo-section-title">
        <img class="light-image-block-l" src="/images/icons/components/layout-2.svg" alt="" />
        <img class="dark-image-block-l" src="/images/icons/components/layout-2-dark.svg" alt="" />
        <div class="title-meta">
          <h3>Navbar Layout</h3>
      ...
      <div class="columns is-multiline">
        <!-- Demo item -->
        <div v-for="(item, index) in navbarDemosFiltered" :key="index" class="column is-4 has-text-centered">
          <figure class="vuero-demo-wrapper loaded">
            <span v-if="item.new" class="new-tag">New</span>
            <img class="light-image-block-l" :src="item.screenshot.light" alt="" loading="lazy" />
            <img class="dark-image-block-l" :src="item.screenshot.dark" alt="" loading="lazy" />
    ...
    <div v-if="minimalDemosFiltered.length > 0" class="demo-section">
      <div class="demo-section-title">
        <img class="light-image-block-l" src="/images/icons/components/layout-3.svg" alt="" />
        <img class="dark-image-block-l" src="/images/icons/components/layout-3-dark.svg" alt="" />
        <div class="title-meta">
      ...
      <div class="columns is-multiline">
        <!-- Demo item -->
        <div v-for="(item, index) in minimalDemosFiltered" :key="index" class="column is-4 has-text-centered">
          <figure class="vuero-demo-wrapper loaded">
            <span v-if="item.new" class="new-tag">New</span>
            <img class="light-image-block-l" :src="item.screenshot.light" alt="" loading="lazy" />
            <img class="dark-image-block-l" :src="item.screenshot.dark" alt="" loading="lazy" />
    ...
    <div v-if="templatesDemosFiltered.length > 0" class="demo-section">
      ...
      <div class="columns is-multiline">
        <!-- Demo item -->
        <div v-for="(item, index) in templatesDemosFiltered" :key="index" class="column is-4 has-text-centered">
          <figure class="vuero-demo-wrapper loaded">
            <span v-if="item.new" class="new-tag">New</span>
            <img class="light-image-block-l" :src="item.screenshot.light" alt="" loading="lazy" />
            <img class="dark-image-block-l" :src="item.screenshot.dark" alt="" loading="lazy" />

    ...
    <div class="message-wrapper has-slimscroll">
      <div class="message-inner">
        ...
        <div class="mail-content content">
          <p>Hello dude,</p>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quare conare, quaeso. Prave, nequiter, turpiter
            cenabat;
            <em>Quid igitur, inquit, eos responsuros putas?</em> Erit enim mecum, si tecum erit.
          </p>
          <p>
            Ratio enim nostra consentit, pugnat oratio. Age sane, inquam. Duo Reges: constructio interrete. Beatus sibi
            videtur esse moriens. Sed ego in hoc resisto; <em>Idemne, quod iucunde?</em>
          </p>
          <p><strong>Tamen a proposito, inquam, aberramus.</strong> Quid de Pythagora?</p>
          <p>
            Cur deinde Metrodori liberos commendas? Non dolere, inquam, istud quam vim habeat postea videro; Pauca mutat
            vel plura sane; Quamquam ab iis philosophiam et omnes ingenuas disciplinas habemus;
          </p>

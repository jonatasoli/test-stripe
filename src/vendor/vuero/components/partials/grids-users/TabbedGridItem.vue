...
<template>
  <div class="grid-item">
    ...
    <div class="icon-tabs-wrapper">
      ...
      <div class="icon-tabs-content subsection-1" :class="[tab === 'posts' && 'is-active']">
      ...
      <div class="icon-tabs-content subsection-2" :class="[tab === 'projects' && 'is-active']">
        <div class="chart-block">
      ...
      <div class="icon-tabs-content subsection-3" :class="[tab === 'tasks' && 'is-active']">
        <div class="chart-block">

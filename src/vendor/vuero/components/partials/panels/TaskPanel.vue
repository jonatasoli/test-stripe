      ...
      <div class="right-panel-body has-slimscroll" data-simplebar>
        <div class="task-group task-overview">
          ...
          <div class="task-description">
            ...
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Videmus igitur ut conquiescere ne infantes quidem
              possint. Duo Reges: constructio interrete... <a>See More</a>
            </p>
          </div>

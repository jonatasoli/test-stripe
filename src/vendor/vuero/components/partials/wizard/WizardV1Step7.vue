  ...
  <div class="step-content">
    ...
    <VLoader size="xl" class="project-preview-wrapper" :active="wizard.loading" grey>
      <div class="project-preview-header">
        <VAvatar color="h-green" size="big" :initials="projectInitial" :picture="projectPicture" />
        ...
        <div class="columns is-multiline">
          <div class="column is-12 is-tablet-100">
            <div class="edit-box">
              ...
              <p v-else>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quis negat? Tamen a proposito, inquam,
                aberramus. Deinde dolorem quem maximum? Quae duo sunt, unum facit. Quod vestri non item.
              </p>
            </div>
          </div>
          ...
          <div class="column is-6 is-tablet-50">
            <div class="edit-box">
              ...
              <VBlock v-if="wizard.data.customer" :title="wizard.data.customer.name" subtitle="Project Customer" center>
                <template #icon>
              ...
              <div class="attachments-count">
                <div class="inner-block">
                  <div class="attachments">
                    <span v-if="wizard.data.attachments.length">{{ wizard.data.attachments.length }}</span>
                    <span v-else>No</span>
                  </div>
                  <p>Attachments</p>
                </div>
          ...
          <div class="column is-6 is-tablet-50">
            <div class="edit-box">
              ...
              <div v-if="wizard.data.teammates.length === 0" class="edit-box-placeholder is-media">
                <span>No selected teammate</span>
              </div>

              <div v-else class="media-list">
                <div v-for="teammate in wizard.data.teammates" :key="teammate.name" class="media-list-item">
                  <VBlock :title="teammate.name" :subtitle="capitalize(teammate.role)" center>
                    <template #icon>
          ...
          <div class="column is-6 is-tablet-50">
            <div class="edit-box">
              ...
              <div v-if="wizard.data.tools.length === 0" class="edit-box-placeholder is-list">
                <span>No selected tools</span>
              </div>

              <div v-else class="media-list">
                <div v-for="tool in wizard.data.tools" :key="tool.name" class="media-list-item">

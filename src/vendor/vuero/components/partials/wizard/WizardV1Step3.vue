  ...
  <div class="step-content">
    ...
    <div class="project-customer">
      ...
      >
        ...
        <template #action>
          <VIconButton size="small" icon="feather:x" circle @click="wizard.data.customer = null" />
        </template>
      </VBlock>
      ...
      <template v-else-if="filteredCustomers.length > 0">
        <transition-group name="list" tag="div">
          ...
          >
            ...
            <template #action>
              <VIconButton size="small" icon="feather:plus" circle @click="wizard.data.customer = customer" />
            </template>
          </VBlock>
        </transition-group>
      </template>

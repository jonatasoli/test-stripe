    ...
    <div ref="dropdownElement1" class="dropdown wizard-dropdown dropdown-trigger">
      ...
      <div id="wizard-navigation-dropdown" class="dropdown-menu" role="menu">
        <div class="dropdown-content">
          <a :class="[wizard.step < 1 && 'is-disabled']" class="dropdown-item kill-drop" @click="setStep(1)">
            Step 1: {{ wizard.stepTitle }}
          </a>
          <a :class="[wizard.step < 2 && 'is-disabled']" class="dropdown-item kill-drop" @click="setStep(2)">
            Step 2: Project Info
          </a>
          <a :class="[wizard.step < 3 && 'is-disabled']" class="dropdown-item kill-drop" @click="setStep(3)">
            Step 3: Project Details
          </a>
          <a :class="[wizard.step < 4 && 'is-disabled']" class="dropdown-item kill-drop" @click="setStep(4)">
            Step 4: Project Files
          </a>
          <a :class="[wizard.step < 5 && 'is-disabled']" class="dropdown-item kill-drop" @click="setStep(5)">
            Step 5: Team Members
          </a>
          <a :class="[wizard.step < 6 && 'is-disabled']" class="dropdown-item kill-drop" @click="setStep(6)">
            Step 6: Project Tools
          </a>
          <a :class="[wizard.step < 7 && 'is-disabled']" class="dropdown-item kill-drop" @click="setStep(7)">
            Step 7: Preview
          </a>
        </div>
      </div>

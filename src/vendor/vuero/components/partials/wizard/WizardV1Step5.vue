  ...
  <div class="step-content">
    ...
    <div v-if="!isAddingMembers" class="page-placeholder is-people">
      <div class="placeholder-content">
        <img class="light-image is-rounded" src="/@src/assets/illustrations/wizard/team-placeholder.svg" alt="" />
        <img class="dark-image is-rounded" src="/@src/assets/illustrations/wizard/team-placeholder.svg" alt="" />
        <h3>Invite People</h3>
        <p class="is-larger">

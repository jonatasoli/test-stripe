  ...
  <div class="step-content">
    ...
    <div v-if="!isUploading" class="page-placeholder is-files">
      <div class="placeholder-content">
        <img class="light-image is-rounded" src="/@src/assets/illustrations/wizard/upload-placeholder.svg" alt="" />
        <img class="dark-image is-rounded" src="/@src/assets/illustrations/wizard/upload-placeholder.svg" alt="" />
        <h3>Upload project files</h3>
        <p class="is-larger">
          You can already start adding files to your project if you have them handy. But don't worry, you'll be able to
          add and manage files later.
        </p>
      ...
      <div ref="previewContainerElement" class="template-list">
        <div ref="previewTemplateElement" class="template-list-item">
          <div class="preview-box">
            ...
            <div class="preview">
              <img data-dz-thumbnail alt="" @error.once="event => useViaPlaceholderError(event, '150x150')" />
            </div>

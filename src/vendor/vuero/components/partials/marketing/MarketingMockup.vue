    ...
    <div class="container">
      ...
      <div class="centered-mockup-wrapper">
        <div class="mockup-container mb-6">
          ...
          <!--Mockup-->
          <img class="light-image-l centered-mockup" src="/@src/assets/illustrations/landing/app-1.png" alt="" />
          <img class="dark-image-l centered-mockup" src="/@src/assets/illustrations/landing/app-1-dark.png" alt="" />
        </div>
        <div class="columns">
          <div class="column is-4">
            <h3 class="title is-4">Bulma 0.9.1</h3>
            <p class="subtitle is-6 light-text">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Summum ením bonum exposuit vacuitatem.
            </p>
          </div>
          <div class="column is-4">

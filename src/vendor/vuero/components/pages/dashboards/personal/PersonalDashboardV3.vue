...
import { progressGaugeOptions, onprogressGaugeReady } from '/@src/data/dashboards/personal-v3/progressChart'
          ...
          <div class="column is-6">
            <div class="dashboard-card is-welcome">
              <div class="welcome-title">
                ...
                <p>You have 6 interviews to conduct during this week. Your current progress is great.</p>
              </div>
              <div class="welcome-progress">
                <VBillboardJS :options="progressGaugeOptions" @ready="onprogressGaugeReady" />
                <div class="meta">
                  <span>Your Progress</span>
                  <span class="dark-inverted">Outstanding <span role="img" aria-label="Party Popper">🎉</span></span>
                </div>
              </div>
              <div class="button-wrap">
                <VButton color="primary" size="big" fullwidth raised> View Schedule </VButton>
              </div>
            </div>
          </div>

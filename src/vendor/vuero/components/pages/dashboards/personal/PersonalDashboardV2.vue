        ...
        <div class="dashboard-card has-margin-bottom">
          ...
          <div class="active-projects">
            ...
            <VBlock title="Banking App Dashboard" subtitle="Updated 10h ago" center>
              <template #icon>
                <VAvatar picture="/demo/photos/apps/4.png" badge="/images/icons/stacks/js.svg" size="medium" squared />
              </template>
              <template #action>
      ...
      <div class="column is-4">
        ...
        <div class="dashboard-card">
          <VPlaceholderSection title="Go Premium" subtitle="Unlock more features and business tools by going premium">
            <template #image>
              <img class="light-image" src="/@src/assets/illustrations/placeholders/chart-guy.svg" alt="" />
              <img class="dark-image" src="/@src/assets/illustrations/placeholders/chart-guy-dark.svg" alt="" />
            </template>

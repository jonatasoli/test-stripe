  ...
  <div class="lifestyle-dashboard lifestyle-dashboard-v2">
    <div class="dashboard-title is-main">
      <div class="left">
        ...
        <p class="h-hidden-mobile">Explore some of the best activities nearby in your region</p>
      </div>
      <div class="right">
    ...
    <div class="columns">
      ...
      <div class="column is-3">
        ...
        <!--Widget-->
        <ListWidgetSingle title="Hot Topics" class="list-widget-v1 p-t-20 p-l-20 p-r-20 p-b-20">

...
import { valueSingle, optionsSingle } from '/@src/data/dashboards/lifestyle-v1/dashboardData'
...
<template>
  <div class="lifestyle-dashboard lifestyle-dashboard-v1">
      ...
      <div class="dashboard-header">
        ...
        <div class="header-meta">
          ...
          <div class="meta-description">
            <p>
              Artist, musician, songwriter, influencer, these are the many names people give me. But for you Iam simply
              Clarissa. *Forever with all my friends* // Latest video can be found here youtu.be/8Tcee5Cyz
            </p>
          </div>
    ...
    <div class="tabs-wrapper">
      ...
      <div v-if="activeTab === 'overview'" id="overview-tab" class="tab-content is-active">
            ...
            <div class="stat-widget flex-stat-widget is-straight">
              <div class="chart-media">
                <div class="meta">
                  ...
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Bonum integritas corporis: misera
                    debilitas. Ita ne hoc quidem modo paria.
                  </p>
                </div>
                ...
                <div class="heatmap-title">
                  ...
                  <div class="title-meta">
                    <p>
                      ...
                      <span>Mondays at 11am</span>, <span>Thursdays at 3pm</span>, <span>Fridays at 4pm</span> ...
                    </p>
                  </div>
                </div>
      ...
      <div v-if="activeTab === 'brands'" id="brands-tab" class="tab-content is-active">
        ...
        <div class="page-placeholder">
          <div class="placeholder-content">
            ...
            <p class="is-larger">
              Too bad. Looks like Clarissa enabled her brand privacy setting. You won't be able to see the brands she's
              working with unless you contact her directly.
            </p>
          </div>
        </div>
      </div>

...
import { members, featuredLeft, featuredRight, feed } from '/@src/data/dashboards/lifestyle-v5'
</script>
      ...
      <div class="right">
        <div class="members">
          ...
          <div class="members-list">
            ...
            <VAvatar v-for="member in members.list" :key="member.id" :picture="member.avatar" size="small" squared />
            ...
            <div class="column is-6">
              <div class="columns is-multiline">
                <div
                  ...
                  :key="item.id"
                  class="column"
                  :class="[item.size === 'large' && 'is-12', item.size === 'regular' && 'is-6']"
                >
                  <div
                    v-background="{
                      src: item.poster,

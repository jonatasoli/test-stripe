            ...
            <div class="dashboard-tile">
              ...
              <div class="tile-foot">
                <span class="text-h-red"
                  >-2.1%
                  <i aria-hidden="true" class="iconify" data-icon="feather:trending-down" />
                </span>
          ...
          <template #body>
            <div class="widget-content">
              <p>
                ...
                >, <span>{{ followersList[1].name }}</span> and <span>{{ followersList[2].name }}</span> are now
                following you. Take some time to look at their profile.
              </p>
            </div>
          </template>
        </UIWidget>

...
import { spark1, spark2, spark3, spark4 } from '/@src/data/widgets/charts/salesSparksChart'
...
import { barData, barData2, salesBarOptions } from '/@src/data/dashboards/sales/salesBarChart'
import { personalScoreGaugeOptions, onPersonalScoreGaugeReady } from '/@src/data/widgets/charts/personalScoreGauge'
          ...
          <div class="dashboard-card flex-chart">
            <div class="chart-media">
              <div class="meta">
                ...
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Bonum integritas corporis: misera debilitas.
        ...
        <div class="column is-3">
          ...
          <div class="widget gauge-widget is-straight">
            ...
            <div class="gauge-wrap">
              ...
              <VBillboardJS :options="personalScoreGaugeOptions" @ready="onPersonalScoreGaugeReady" />
            </div>

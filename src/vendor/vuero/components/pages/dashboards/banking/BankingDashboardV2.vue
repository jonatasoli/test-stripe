...
import { valueSingle, optionsSingle } from '/@src/data/dashboards/banking-v2/dashboardData'
                ...
                <div ref="sliderElement" class="cards-carousel-inner">
                  ...
                  <div class="cards-carousel-item" @click="goto(0)">
                    <div class="ccard">
                      <div class="shape"></div>
                      <div class="top">
                        <img class="active" src="/images/icons/dashboards/banking/visa-text-white.svg" alt="" />
                        <img

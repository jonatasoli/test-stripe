      ...
      <div class="column is-4">
        ...
        <div class="dashboard-card is-side">
          ...
          <div class="currency-description">
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vide, quantum, inquam, fallare, Torquate. Quid
              censes in Latino fore? Optime, inquam. Ratio quidem vestra sic cogit. Prave, nequiter, turpiter cenabat;
        ...
        <div class="dashboard-card is-side">
          ...
          <div class="people">
            <tippy class="has-help-cursor" interactive :offset="[0, 40]" placement="top-end">

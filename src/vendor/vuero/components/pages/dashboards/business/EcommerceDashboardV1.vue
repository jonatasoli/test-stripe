...
import { spark1, spark2, spark3, spark4 } from '/@src/data/dashboards/ecommerce/sparksCharts'
import {
...
import { valueSingle, optionsSingle, flexRowsOrders } from '/@src/data/dashboards/ecommerce/dashboardData'
</script>

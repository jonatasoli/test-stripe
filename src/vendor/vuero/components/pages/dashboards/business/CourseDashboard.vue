      ...
      <div class="columns is-multiline">
        ...
        <div v-for="course in courses" :key="course.id" class="column is-4">
          <div class="course-card">
            ...
            <p>{{ course.summary }}</p>
            <div class="students">
              <VAvatar v-for="student in course.students" :key="student.id" :picture="student.picture" size="small" />
            ...
            <div class="action-block">
              <button class="button h-button is-primary is-raised is-fullwidth">View Class</button>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="right">
            <div class="field">
              <div class="control has-icon">
                <input type="text" class="input is-rounded" placeholder="Search students..." />
                <div class="form-icon">
        ...
        <div class="flex-table">
          ...
          <div v-for="student in students" :key="student.id" class="flex-table-item">
            ...
            <div class="flex-table-cell cell-end" data-th="Actions">
              <button class="button h-button action-button is-dark-outlined is-pushed-mobile">Chat</button>
            </div>
          </div>
        </div>
      </div>

...
// You can set the VITE_MAPBOX_ACCESS_TOKEN inside .env.sample file
...
function loadLayers() {
  ...
  map.addLayer({
    ...
    paint: {
      ...
      'circle-stroke-color': isDark.value ? themeColors.accentLight : themeColors.primaryMedium
    }
  })
...
onMounted(() => {
  ...
  map = new mapboxgl.Map({
    ...
    style: isDark.value ? 'mapbox://styles/mapbox/dark-v10' : 'mapbox://styles/mapbox/light-v10',
    center: [-77.04, 38.907],
    zoom: 12
  })
              ...
              <div class="map-box-actions">
                ...
                <div class="actions">
                  <div class="action">
                    ...
                    <span class="dark-inverted"> {{ feature.properties.distance }} mile </span>
                  </div>
                </div>
              </div>
            </div>

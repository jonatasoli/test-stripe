    ...
    <div class="columns is-multiline">
      <div class="column is-4">
        <div class="dashboard-card is-company">
          <VAvatar size="big" picture="/demo/photos/brands/udemy.svg" picture-dark="/demo/photos/brands/udemy-dark.svg">
            <template #badge>
          ...
          <div class="description">
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed fac ista esse non inportuna.</p>
          </div>

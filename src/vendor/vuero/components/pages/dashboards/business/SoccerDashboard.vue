      ...
      <div class="columns">
        <div class="column is-4">
          ...
          <div class="live-match">
            ...
            <div class="match">
              <div class="left">
                <img class="team-logo" src="/images/icons/soccer/teams/barcelona.svg" alt="" />
          ...
          <div class="leagues">
            ...
            <div class="leagues-list">
              <RouterLink :to="{ name: 'sidebar-dashboards-soccer' }" class="league-item">
                <img class="league-logo" src="/images/icons/soccer/leagues/ligue-1.svg" alt="" />
                <div class="meta">
              ...
              <RouterLink :to="{ name: 'sidebar-dashboards-soccer' }" class="league-item">
                <img class="league-logo" src="/images/icons/soccer/leagues/laliga.svg" alt="" />
                <div class="meta">
              ...
              <RouterLink :to="{ name: 'sidebar-dashboards-soccer' }" class="league-item">
                <img class="league-logo" src="/images/icons/soccer/leagues/liga.svg" alt="" />
                <div class="meta">
              ...
              <RouterLink :to="{ name: 'sidebar-dashboards-soccer' }" class="league-item">
                <img class="league-logo" src="/images/icons/soccer/leagues/bundesliga.svg" alt="" />
                <div class="meta">
        ...
        <div class="column is-8">
          ...
          <div class="dashboard-cta">
            ...
            <p class="dashboard-cta-text">
              Predict who will win and how a match will end and get a chance to win incredible cash prizes.
            </p>
                ...
                <tbody>
                    ...
                    <td class="score-cell">
                      <div class="score score-vertical">
                        <div class="score-team score-team-vertical">
                          <span>Barcelona</span><img alt="" src="/images/icons/soccer/teams/barcelona.svg" />
                        </div>
                        <p class="score-result score-result-vertical">
                          <span class="score-goals">4</span><span class="score-separator">:</span
                          ><span class="score-goals">0</span>
                        </p>
                        <div class="score-team score-team-vertical">
                          <img alt="" src="/images/icons/soccer/teams/psg.svg" /><span>PSG</span>
                        </div>
                      </div>
                    </td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td class="score-cell">
                      <div class="score score-vertical">
                        <div class="score-team score-team-vertical">
                          <span>Real Madrid</span><img alt="" src="/images/icons/soccer/teams/madrid.svg" />
                        </div>
                        <p class="score-result score-result-vertical">
                          <span class="score-goals">1</span><span class="score-separator">:</span
                          ><span class="score-goals">0</span>
                        </p>
                        <div class="score-team score-team-vertical">
                          <img alt="" src="/images/icons/soccer/teams/liverpool.svg" /><span>Liverpool</span>
                        </div>
                      </div>
                    </td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td class="score-cell">
                      <div class="score score-vertical">
                        <div class="score-team score-team-vertical">
                          <span>Arsenal</span><img alt="" src="/images/icons/soccer/teams/arsenal.svg" />
                        </div>
                        <p class="score__result score__result--vertical score__result--not-started">
                          <span class="score-goals">-</span><span class="score-separator">:</span
                          ><span class="score-goals">-</span>
                        </p>
                        <div class="score-team score-team-vertical">
                          <img alt="" src="/images/icons/soccer/teams/chelsea.svg" /><span>Chelsea</span>
                        </div>
                      </div>
                    </td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td class="score-cell">
                      <div class="score score-vertical">
                        <div class="score-team score-team-vertical">
                          <span>Everton</span><img alt="" src="/images/icons/soccer/teams/everton.svg" />
                        </div>
                        <p class="score__result score__result--vertical score__result--not-started">
                          <span class="score-goals">-</span><span class="score-separator">:</span
                          ><span class="score-goals">-</span>
                  ...
                  <tr>
                    ...
                    <td class="score-cell">
                      <div class="score score-vertical">
                        <div class="score-team score-team-vertical">
                          <span>Valladolid</span><img alt="" src="/images/icons/soccer/teams/valladolid.svg" />
                        </div>
                        <p class="score__result score__result--vertical score__result--not-started">
                          <span class="score-goals">-</span><span class="score-separator">:</span
                          ><span class="score-goals">-</span>
                        ...
                        <div class="score-team score-team-vertical">
                          <img alt="" src="/images/icons/soccer/teams/zagreb.svg" /><span>Zagreb</span>
                        </div>
                      </div>
                    </td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td class="score-cell">
                      <div class="score score-vertical">
                        <div class="score-team score-team-vertical">
                          <span>PSG</span><img alt="" src="/images/icons/soccer/teams/psg.svg" />
                        </div>
                        <p class="score__result score__result--vertical score__result--not-started">
                          <span class="score-goals">-</span><span class="score-separator">:</span
                          ><span class="score-goals">-</span>

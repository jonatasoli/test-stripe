      ...
      <div class="main-container">
        ...
        <div class="search-type">
          ...
          <div class="job-time">
            ...
            <div class="job-wrapper">
              <div class="type-container">
                <V-Checkbox v-model="jobType" value="job-type-1" label="Full Time Jobs" color="primary" paddingless />
                <span class="job-number">56</span>
              </div>
              <div class="type-container">
                <V-Checkbox v-model="jobType" value="job-type-2" label="Part Time Jobs" color="primary" paddingless />
                <span class="job-number">43</span>
              </div>
              <div class="type-container">
                <V-Checkbox v-model="jobType" value="job-type-3" label="Remote Jobs" color="primary" paddingless />
                <span class="job-number">24</span>
              </div>
              <div class="type-container">
                <V-Checkbox v-model="jobType" value="job-type-4" label="Internship Jobs" color="primary" paddingless />
                <span class="job-number">27</span>
              </div>
              <div class="type-container">
                <V-Checkbox v-model="jobType" value="job-type-5" label="Contract" color="primary" paddingless />
                <span class="job-number">76</span>
              </div>
              <div class="type-container">
                <V-Checkbox v-model="jobType" value="job-type-6" label="Training Jobs" color="primary" paddingless />
          ...
          <div class="job-time">
            ...
            <div class="job-wrapper">
              <div class="type-container">
                <V-Checkbox v-model="jobSalary" value="job-salary-1" label="$700 - $1000" color="primary" paddingless />

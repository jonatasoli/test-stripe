    ...
    <div class="columns is-multiline project-grid is-flex-tablet-p is-half-tablet-p">
      ...
      <div class="column is-one-fifth">
        <a class="project-grid-item">
          ...
          <progress class="progress is-primary is-tiny" value="45" max="100">45%</progress>
        </a>
      </div>
      ...
      <div class="column is-12">
        <div class="flex-table is-compact">
          ...
          <div class="flex-table-item">
            ...
            <div class="flex-table-cell" data-th="Contacts">
              <v-avatar-stack class="is-pushed-mobile" size="small" :avatars="[{ color: 'danger', initials: 'SC' }]" />
            </div>
            <div class="flex-table-cell cell-end" data-th="Actions">
              <flex-table-dropdown />
            </div>
          ...
          <div class="flex-table-item">
            ...
            <div class="flex-table-cell" data-th="Contacts">
              <v-avatar-stack
                class="is-pushed-mobile"
                size="small"
                :avatars="[{ color: 'success', initials: 'BT' }, { picture: '/images/avatars/svg/vendor-1.svg' }]"
              />
            </div>
            <div class="flex-table-cell cell-end" data-th="Actions">
              <flex-table-dropdown />
          ...
          <div class="flex-table-item">
            ...
            <div class="flex-table-cell" data-th="Contacts">
              <v-avatar-stack class="is-pushed-mobile" size="small" :avatars="[{ picture: '/demo/avatars/13.jpg' }]" />
            </div>
            <div class="flex-table-cell cell-end" data-th="Actions">
              <flex-table-dropdown />
            </div>

...
const participants = [
  ...
  { picture: '/images/avatars/svg/vendor-1.svg' },
...
<template>
  <div class="project-details">
    <div class="tabs-wrapper is-triple-slider">
      ...
      <div class="tab-content is-active" v-if="tab === 'project'">
          ...
          <div class="column is-8">
            <div class="project-details-card">
              <div class="card-head">
                ...
                <v-icon-button size="small" icon="feather:edit-3" @click="activePanel = 'task'" />
              </div>

              <div class="project-overview">
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quid iudicant sensus? Primum quid tu dicis
                  breve? Etiam beatissimum? Ne discipulum abducam, times.
                </p>
                <v-avatar-stack :avatars="participants" />
              </div>
              ...
              <div class="project-features">
                <div class="project-feature">
                  ...
                  <h4>UI/UX Design</h4>
                  <p>Designing a perfect user experience is in the scope of this project.</p>
                </div>
                <div class="project-feature">
                  <i aria-hidden="true" class="lnil lnil-alarm-clock"></i>
                  <h4>1 Week Sprints</h4>
                  <p>This project development iterations follow a 1 week sprint pattern.</p>
                </div>
                <div class="project-feature">
                  <i aria-hidden="true" class="lnil lnil-calendar"></i>
                  <h4>3 Months</h4>
                  <p>This project and all related tasks should completed within 3 months.</p>
                </div>
                <div class="project-feature">
          ...
          <div class="column is-4">
            <div class="side-card">
              ...
              <v-block center title="Sketch" subtitle="Design Software">
                <template #icon>
                  <v-avatar size="small" picture="/images/icons/stacks/sketch.svg" />
                </template>
              </v-block>

              <v-block center title="Illustrator" subtitle="Design Software">
                <template #icon>
                  <v-avatar size="small" picture="/images/icons/stacks/illustrator.svg" />
                </template>
              </v-block>

              <v-block center title="Photoshop" subtitle="Design Software">
                <template #icon>
                  <v-avatar size="small" picture="/images/icons/stacks/photoshop.svg" />
                </template>
              </v-block>
            </div>
            ...
            <div class="side-card">
              ...
              <v-block center title="Html5" subtitle="Hypertext Markup">
                <template #icon>
                  <v-avatar size="small" picture="/images/icons/stacks/html5.svg" />
                </template>
              </v-block>

              <v-block center title="CSS3" subtitle="Cascading Stylesheets">
                <template #icon>
                  <v-avatar size="small" picture="/images/icons/stacks/css3.svg" />
                </template>
              </v-block>

              <v-block center title="VueJS" subtitle="Javascript Framework">
                <template #icon>
                  <v-avatar size="small" picture="/images/icons/stacks/vuejs.svg" />
                </template>
              </v-block>
            </div>
            ...
            <div class="side-card">
              ...
              <v-block center title="VFlights" subtitle="Transportation company">
                <template #icon>
                  <v-avatar size="small" picture="/@src/assets/illustrations/dashboards/flights/company1.svg" />
                </template>
              </v-block>
            </div>
          </div>
      ...
      <!--Project Team-->
      <div class="tab-content is-active" v-if="tab === 'team'">
          ...
          <div class="project-team-card">
            <div class="columns is-multiline">
              ...
              <div class="column is-6 has-border-bottom">
                ...
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Si enim ad populum me vocas, eum. Quod cum
                  dixissent, ille contra. Cur id non ita fit? Duo Reges: constructio interrete.
                </p>
              </div>
              <!--Team Member-->
              <div class="column is-6 has-border-bottom">
              ...
              <div class="column is-6 has-border-bottom">
                <v-block center title="Erik K." subtitle="Product Manager">
                  <template #icon>
                    <v-avatar size="medium" picture="/images/avatars/svg/vuero-1.svg" />
                  </template>
      ...
      <div class="tab-content is-active" v-if="tab === 'tasks'">
        <div class="project-details-inner">
          <div class="task-grid">
            ...
            <div class="columns is-multiline">
              ...
              <div class="column is-4">
                <div class="task-card right-panel-trigger">
                  ...
                  <div class="content-wrap">
                    <div class="left">
                      <v-avatar-stack size="small" :avatars="[{ picture: '/demo/avatars/12.jpg' }]" />
                      <div class="attachments">
                        <i aria-hidden="true" class="lnil lnil-paperclip"></i>
                ...
                <div class="task-card right-panel-trigger">
                  ...
                  <div class="content-wrap">
                    <div class="left">
                      <v-avatar-stack
                        size="small"
                        :avatars="[{ picture: '/demo/avatars/5.jpg' }, { picture: '/demo/avatars/7.jpg' }]"
                      />
                      <div class="attachments">
                        <i aria-hidden="true" class="lnil lnil-paperclip"></i>
                        <span>1 attachment</span>
              ...
              <div class="column is-4">
                <div class="task-card right-panel-trigger">
                  ...
                  <div class="content-wrap">
                    <div class="left">
                      <v-avatar-stack size="small" :avatars="[{ picture: '/demo/avatars/25.jpg' }]" />
                      <div class="attachments">
                        <i aria-hidden="true" class="lnil lnil-paperclip"></i>
                ...
                <div class="task-card right-panel-trigger">
                  ...
                  <div class="content-wrap">
                    <div class="left">
                      <v-avatar-stack
                        size="small"
                        :avatars="[{ picture: '/demo/avatars/25.jpg' }, { picture: '/demo/avatars/12.jpg' }]"
                      />
                      <div class="attachments">
                        <i aria-hidden="true" class="lnil lnil-paperclip"></i>
                        <span>3 attachments</span>

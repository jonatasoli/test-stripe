  ...
  <div class="invoice-wrapper">
    ...
    <div class="invoice-body">
      <div class="invoice-card">
        ...
        <div class="invoice-section is-flex is-bordered">
          <VAvatar size="large" class="is-customer" picture="/demo/photos/brands/airbnb.svg" />
          ...
          <div class="end is-left">
            <h3>Description</h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quod equidem non reprehendo.</p>
          </div>
        </div>

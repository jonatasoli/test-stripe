      ...
      <div class="wrapper-inner">
        <div class="action-box">
          <div class="box-content">
            <img class="light-image is-larger" src="/@src/assets/illustrations/placeholders/promotion.svg" alt="" />
            <img class="dark-image is-larger" src="/@src/assets/illustrations/placeholders/promotion-dark.svg" alt="" />
            <h3 class="dark-inverted">Empower your team to do greater things collaboratively</h3>
            <div class="price">
      ...
      <div class="side-wrapper">
        <div class="side-inner">
          ...
          <div class="action-list">
            ...
            <VBlock title="Scale">
              <p>Your application grows in parallel of your business, without any effort.</p>

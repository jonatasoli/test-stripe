      ...
      <div class="wrapper-inner">
        <div class="action-box">
          <div class="box-content">
            <VAvatar size="big" picture="/demo/avatars/16.jpg" badge="/demo/photos/apps/9.png" />
            ...
            <div class="sender-message is-dark-card-bordered is-dark-bg-4">
              ...
              <p>
                Hey Erik, It would be really cool if you could give us a hand on this project. There are a lot of tasks
                popping out every day and I feel the team is getting a bit overwhelmed. We'd love to have you board.
              </p>
            </div>
            ...
            <div class="buttons">
              ...
              <VButton color="primary" :loading="isLoading" raised @click="accept"> Accept </VButton>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="side-inner">
          ...
          <div class="action-list">
            <VBlock title="Project Summary">
              ...
              <template #icon>
                <VIconWrap icon="feather:check" dark="3" dark-primary dark-card-bordered />
              </template>
            </VBlock>

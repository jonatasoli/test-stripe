  ...
  <div>
    ...
    <div class="page-content-inner">
      ...
      <div class="list-view list-view-v3">
        ...
        <!--Active Tab-->
        <div id="active-items-tab" class="tab-content" :class="[activeTab === 'all' && 'is-active']">
        ...
        <!--Inactive Tab-->
        <div id="inactive-items-tab" class="tab-content" :class="[activeTab === 'saved' && 'is-active']">
          <div class="list-view-inner">
            <!--Empty placeholder-->
            <VPlaceholderPage
              title="No saved jobs."
            ...
            >
              <template #image>
                <img class="light-image" src="/@src/assets/illustrations/placeholders/thinking-canvas.svg" alt="" />
                <img class="dark-image" src="/@src/assets/illustrations/placeholders/thinking-canvas-dark.svg" alt="" />
              </template>
            </VPlaceholderPage>
          </div>
        </div>

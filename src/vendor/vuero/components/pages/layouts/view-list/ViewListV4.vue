    ...
    <div class="list-view list-view-v4">
      ...
      >
        <template #image>
          ...
          <img class="dark-image" src="/@src/assets/illustrations/placeholders/search-3-dark.svg" alt="" />
        </template>
      </VPlaceholderPage>
            ...
            <div v-for="(item, key) in filteredData" :key="key" class="list-view-item">
              <div class="list-view-item-inner">
                ...
                <div class="meta-right">
                  ...
                  <div class="buttons">
                    <a class="button v-button is-primary is-outlined is-raised"> View Recipe </a>
                    <button class="button is-light is-circle hint--bubble hint--primary hint--top" data-hint="Save">
      ...
      <div id="inactive-items-tab" class="tab-content" :class="[tab === 'saved' && 'is-active']">
        <div class="list-view-inner">
          ...
          >
            <template #image>
              <img class="light-image" src="/@src/assets/illustrations/placeholders/cooking.svg" alt="" />
              <img class="dark-image" src="/@src/assets/illustrations/placeholders/cooking-dark.svg" alt="" />
            </template>
          </VPlaceholderPage>
        </div>
      </div>

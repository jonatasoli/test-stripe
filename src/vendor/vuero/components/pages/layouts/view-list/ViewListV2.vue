...
<template>
  ...
  <div class="page-content-inner">
    ...
    <div class="list-view list-view-v2">
      ...
      >
        <template #image>
          <img class="light-image" src="/@src/assets/illustrations/placeholders/search-2.svg" alt="" />
          <img class="dark-image" src="/@src/assets/illustrations/placeholders/search-2-dark.svg" alt="" />
        </template>
      </VPlaceholderPage>

      <!--Active Tab-->
      <div id="active-items-tab" class="tab-content" :class="[activeTab === 'active' && 'is-active']">
              ...
              <div class="list-view-item-inner">
                ...
                <div class="meta-left">
                  <h3>
                    <span>{{ item.name }}</span>
                    <span class="rating">
                      <i class="fas fa-star" aria-hidden="true" :class="[item.rating >= 1 && 'active']"></i>
                      <i class="fas fa-star" aria-hidden="true" :class="[item.rating >= 2 && 'active']"></i>
                      <i class="fas fa-star" aria-hidden="true" :class="[item.rating >= 3 && 'active']"></i>
                      <i class="fas fa-star" aria-hidden="true" :class="[item.rating >= 4 && 'active']"></i>
                      <i class="fas fa-star" aria-hidden="true" :class="[item.rating >= 5 && 'active']"></i>
                    </span>
                  </h3>
                  <p>
                  ...
                  <span>
                    <span>
                      {{ item.details.rooms > 1 ? `${item.details.rooms} rooms` : `${item.details.rooms} room` }}
                    </span>
                    <i aria-hidden="true" class="fas fa-circle icon-separator"></i>
                    <span>
                      {{ item.details.beds > 1 ? `${item.details.beds} beds` : `${item.details.beds} bed` }}
                    </span>
                    <i aria-hidden="true" class="fas fa-circle icon-separator"></i>
                    <span>
                      {{
                  ...
                  <div class="icon-list">
                    ...
                    <span
                      v-else-if="item.comodities.other && item.comodities.otherThing && item.comodities.otherCoolThing"
                    >
                      <i aria-hidden="true" class="lnil lnil-more"></i>
                      <span>3 more</span>
                    </span>
      ...
      <!--Inactive Tab-->
      <div id="inactive-items-tab" class="tab-content" :class="[activeTab === 'inactive' && 'is-active']">
        <div class="list-view-inner">
          <!--Empty placeholder-->
          <VPlaceholderPage
          ...
          >
            <template #image>
              <img class="light-image" src="/@src/assets/illustrations/placeholders/having-coffee.svg" alt="" />
              <img class="dark-image" src="/@src/assets/illustrations/placeholders/having-coffee-dark.svg" alt="" />
            </template>
          </VPlaceholderPage>
        </div>
      </div>

    ...
    <div class="tile-grid tile-grid-v3">
      ...
      <div class="tile is-ancestor">
        <div class="tile is-parent">
          <a href="#" class="tile is-child tile-grid-item is-medium">
            <div class="tile-grid-item-inner">
              <img src="/demo/photos/11.jpg" alt="" @error.once="event => useViaPlaceholderError(event, '400x300')" />
              <div class="meta">
                <div class="tile-title">
                  <h3 class="dark-inverted" data-filter-match>How to serve coffee at the office the proper way</h3>
        ...
        <div class="tile is-parent">
          <a href="#" class="tile is-child tile-grid-item is-medium">
            <div class="tile-grid-item-inner">
              <img src="/demo/photos/12.jpg" alt="" @error.once="event => useViaPlaceholderError(event, '400x300')" />
              <div class="meta">
                <div class="tile-title">
                  <h3 class="dark-inverted" data-filter-match>Teamwork can dramatically increase productivity</h3>
                  <p class="h-hidden-tablet-l h-hidden-desktop">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Optime, inquam. Duo Reges constructio.
                  </p>
                </div>
        ...
        <div class="tile is-parent">
          <a href="#" class="tile is-child tile-grid-item is-medium">
            <div class="tile-grid-item-inner">
              <img src="/demo/photos/13.jpg" alt="" @error.once="event => useViaPlaceholderError(event, '400x300')" />
              <div class="meta">
                <div class="tile-title">
                  <h3 class="dark-inverted" data-filter-match>Is team building a scam or the next thing?</h3>
                  <p class="h-hidden-tablet-l h-hidden-desktop">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Optime, inquam. Duo Reges constructio.
                  </p>
                </div>
      ...
      <div class="tile is-ancestor">
        <div class="tile is-vertical is-8">
            ...
            <div class="tile is-parent">
              <a href="#" class="tile is-child tile-grid-item is-large">
                <div class="tile-grid-item-inner">
                  ...
                  <div class="meta">
                    <div class="tile-title">
                      <h3 class="dark-inverted" data-filter-match>Finding the right spot for your startup</h3>
                      <p class="h-hidden-tablet-l h-hidden-desktop">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Optime, inquam. Duo Reges constructio.
                      </p>
                    </div>
          ...
          <div class="tile is-parent">
            <a href="#" class="tile is-child tile-grid-item is-wide">
              <div class="tile-grid-item-inner">
                <img src="/demo/photos/18.jpg" alt="" @error.once="event => useViaPlaceholderError(event, '400x300')" />
                <div class="meta">
                  <div class="tile-title">
                    <h3 class="dark-inverted" data-filter-match>4 tips to make your business lunches awesome</h3>
                    <p>
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Optime, inquam. Duo Reges constructio.
                    </p>
        ...
        <div class="tile is-parent">
          <a href="#" class="tile is-child tile-grid-item is-tall">
            <div class="tile-grid-item-inner">
              <img src="/demo/photos/19.jpg" alt="" @error.once="event => useViaPlaceholderError(event, '400x300')" />
              <div class="meta">
                <div class="tile-title">
                  <h3 class="dark-inverted" data-filter-match>Setting up a design system for your app project</h3>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Optime, inquam. Duo Reges constructio.</p>
                  <p class="h-hidden-mobile h-hidden-tablet-p">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Optime, inquam. Duo Reges constructio.
                  </p>
                </div>
      ...
      <div class="tile is-ancestor">
        <div class="tile is-parent">
          <a href="#" class="tile is-child tile-grid-item is-wide">
            <div class="tile-grid-item-inner">
              <img src="/demo/photos/20.jpg" alt="" @error.once="event => useViaPlaceholderError(event, '400x300')" />
              <div class="meta">
                <div class="tile-title">
                  <h3 class="dark-inverted" data-filter-match>Foundation of a great E-Learning system</h3>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Optime, inquam. Duo Reges constructio.</p>
                </div>
                <div class="tile-meta">
        ...
        <div class="tile is-parent is-6">
          <a href="#" class="tile is-child tile-grid-item is-wide">
            <div class="tile-grid-item-inner">
              <img src="/demo/photos/23.jpg" alt="" @error.once="event => useViaPlaceholderError(event, '400x300')" />
              <div class="meta">
                <div class="tile-title">
                  <h3 class="dark-inverted" data-filter-match>Why it pays to profile your customers</h3>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Optime, inquam. Duo Reges constructio.</p>
                </div>
                <div class="tile-meta">
      ...
      <div class="tile is-ancestor">
        <div class="tile is-parent">
          <a href="#" class="tile is-child tile-grid-item is-medium">
            <div class="tile-grid-item-inner">
              <img src="/demo/photos/22.jpg" alt="" @error.once="event => useViaPlaceholderError(event, '400x300')" />
              <div class="meta">
                <div class="tile-title">
                  <h3 class="dark-inverted" data-filter-match>Using flashy colors in your websites and apps</h3>
                  <p class="h-hidden-tablet-l h-hidden-desktop">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Optime, inquam. Duo Reges constructio.
                  </p>
                </div>
        ...
        <div class="tile is-parent">
          <a href="#" class="tile is-child tile-grid-item is-medium">
            <div class="tile-grid-item-inner">
              <img src="/demo/photos/24.jpg" alt="" @error.once="event => useViaPlaceholderError(event, '400x300')" />
              <div class="meta">
                <div class="tile-title">
                  <h3 class="dark-inverted" data-filter-match>Building a consistent and talented team</h3>
                  <p class="h-hidden-tablet-l h-hidden-desktop">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Optime, inquam. Duo Reges constructio.
                  </p>
                </div>
        ...
        <div class="tile is-parent">
          <a href="#" class="tile is-child tile-grid-item is-medium">
            <div class="tile-grid-item-inner">
              <img src="/demo/photos/27.jpg" alt="" @error.once="event => useViaPlaceholderError(event, '400x300')" />
              <div class="meta">
                <div class="tile-title">
                  <h3 class="dark-inverted" data-filter-match>Diving into building an e-commerce brand - part 1</h3>
                  <p class="h-hidden-tablet-l h-hidden-desktop">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Optime, inquam. Duo Reges constructio.
                  </p>
                </div>

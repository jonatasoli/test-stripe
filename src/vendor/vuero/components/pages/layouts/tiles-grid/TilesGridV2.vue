...
const optionsSingle = ['All Files', 'Recently Updated', 'My Files', 'Team Files', 'Deprecated']
</script>
        ...
        <div v-for="item in filteredData" :key="item.id" class="column is-4">
          <div class="tile-grid-item">
            <div class="tile-grid-item-inner">
              <img :src="item.icon" alt="" @error.once="event => useViaPlaceholderError(event, '150x150')" />
              <div class="meta">

...
import { todoList1, todoList2, todoList3, todoList4 } from '/@src/data/widgets/list/todoList'
...
<template>
  <div class="columns is-multiline widget-demo-columns half-columns">
    ...
    <!--List Widget V2-->
    <div class="column is-4">
      <ListWidgetTabbed title="Todo" straight :labels="['All', 'Mine']" class="list-widget-v2">
        <template #tab1>

...
import { socialButtonList1, socialButtonList2 } from '/@src/data/widgets/ui/socialButtonList'
      ...
      <UIWidget class="text-widget">
        ...
        <template #body>
          <div class="widget-content">
            <p>Vuero will be released very soon, probably around the end of the year of the Christmas holidays.</p>
            <p class="hashtags">
              <a>#uikit</a>
              <a>#dashboards</a>
              <a>#bulma</a>

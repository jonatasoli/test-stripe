...
<template>
  <div class="columns is-multiline">
    ...
    <div class="column is-12">
      <TableWidget title="Members" action-label="Add Member" :data="memberList" straight squared />
    </div>

    <!--Table Widget-->
    <div class="column is-12">
      <TableWidget title="Members" action-label="Add Member" :data="memberList" straight circled />
    </div>
  </div>
</template>

  ...
  <div class="columns is-multiline widget-demo-columns">
        ...
        <template #body>
          <div class="widget-content">
            <p>
              ...
              >, <span>{{ followersList[1].name }}</span> and <span>{{ followersList[2].name }}</span> are now following
    ...
    <div class="column is-3">
      ...
      <UIWidget class="text-widget">
        ...
        <template #body>
          <div class="widget-content">
            <p>You have an upcoming payment for your recurring subscription fee due on <span>Sept 20, 2020</span>.</p>
          </div>
        </template>
      </UIWidget>
          ...
          <div class="widget-content">
            <div class="has-text-centered">
              <div class="stat-number">
                <span
                  >$1638,42
                  <i aria-hidden="true" class="iconify" data-icon="feather:trending-up"></i>
                </span>
        ...
        <template #body>
          <div class="widget-content">
            <p>
              ...
              <span>10 unread messages</span> in your inbox. It could be a good time to check them out.
            </p>
          </div>
        </template>
      </UIWidget>

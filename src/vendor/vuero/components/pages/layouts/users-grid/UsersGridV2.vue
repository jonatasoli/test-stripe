        ...
        <div v-for="item in filteredData" :key="item.id" class="column is-3">
          <div class="grid-item-wrap">
            <div class="grid-item-head">
              <div class="flex-head">
                <div class="meta">
                  <span v-if="item.status === 'synced'" class="dark-inverted"> In Sync </span>
                  <span v-if="item.status === 'overdue'" class="dark-inverted"> Overdue </span>
                  <span v-if="item.status === 'blocked'" class="dark-inverted"> Blocked </span>

...
<template>
  <div>
    ...
    <div class="user-grid user-grid-v3">
      ...
      >
        <template #image>
          <img class="light-image" src="/@src/assets/illustrations/placeholders/search-5.svg" alt="" />
          <img class="dark-image" src="/@src/assets/illustrations/placeholders/search-5-dark.svg" alt="" />
        </template>
      </VPlaceholderPage>

      <!--Active Tab-->
      <div id="active-items-tab" class="tab-content" :class="[tab === 'all' && 'is-active']">
        <transition-group name="list" tag="div" class="columns is-multiline is-flex-tablet-p is-half-tablet-p">
          <!--Grid item-->
      ...
      <!--inactive Tab-->
      <div id="inactive-items-tab" class="tab-content" :class="[tab === 'team' && 'is-active']">
        <!--Empty placeholder-->
        <VPlaceholderPage
        ...
        >
          <template #image>
            <img class="light-image is-larger" src="/@src/assets/illustrations/placeholders/team.svg" alt="" />
            <img class="dark-image is-larger" src="/@src/assets/illustrations/placeholders/team-dark.svg" alt="" />
          </template>
        </VPlaceholderPage>
      </div>
    </div>

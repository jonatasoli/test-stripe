...
const optionsSingle = ['All Projects', 'Web Apps', 'Mobile Apps', 'Dashboards', 'Landing Pages']
</script>
            ...
            <div class="card">
              ...
              <div class="card-image">
                <figure class="image is-16by9">
                  <img :src="item.image" alt="" @error.once="event => useViaPlaceholderError(event, '1280x960')" />
                </figure>
              </div>
              <div class="card-content">
                <div class="card-content-flex">
                  <div class="card-info">
                    ...
                    <p><i aria-hidden="true" class="iconify" data-icon="feather:calendar"> </i>{{ item.dueDate }}</p>
                  </div>

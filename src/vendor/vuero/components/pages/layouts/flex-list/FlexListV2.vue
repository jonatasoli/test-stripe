...
<template>
  <div>
    ...
    <div class="flex-list-wrapper flex-list-v2">
      ...
      <!--Active Tab-->
      <div id="active-items-tab" class="tab-content" :class="[tab === 'active' && 'is-active']">
            ...
            <transition-group name="list" tag="div">
              ...
              <div v-for="item in filteredData" :key="item.id" class="flex-table-item">
                <div class="flex-table-cell is-media is-grow">
                  ...
                  <div>
                    ...
                    <span class="item-meta">
                      <span>
                        <i aria-hidden="true" class="iconify" data-icon="feather:clock"> </i>{{ item.duration }}</span
                      >
                    </span>
                  </div>
                </div>
                ...
                <div class="flex-table-cell h-hidden-tablet-p" data-th="Relations">
                  <VAvatarStack :avatars="item.team" size="small" :limit="3" class="is-pushed-mobile" />
                </div>
      ...
      <!--inactive Tab-->
      <div id="inactive-items-tab" class="tab-content" :class="[tab === 'closed' && 'is-active']">
        <!--Empty placeholder-->
        <VPlaceholderPage

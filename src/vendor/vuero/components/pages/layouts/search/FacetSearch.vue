          ...
          <div class="tab-content" :class="[activeTab === 'all' && 'is-active']">
            ...
            <div class="search-results-group">
              ...
              <div class="search-results-list">
                <!--Item-->
                <div v-for="(person, index) in people" :key="index" class="search-results-item">
            ...
            <div class="search-results-group">
              ...
              <div class="search-results-list">
                <!--Item-->
                <div v-for="(record, index) in records" :key="index" class="search-results-item">
                  <VBlock :title="record.name" :subtitle="record.date" center>
                    <template #icon>
                      <VAvatar size="medium" :picture="record.preview" :squared="record.squared" />
                    </template>
                    <template #action>

      ...
      <ul class="steps has-content-centered is-thin is-horizontal is-short">
        <li :class="[currentStep === 0 && 'is-active']" class="steps-segment">
          ...
          <a
            href="#"
            class="steps-content"
            @click.prevent="currentStep >= 0 && scrollTo('#form-step-0', 800, { offset: -150 })"
          >
        ...
        <li :class="[currentStep === 1 && 'is-active']" class="steps-segment">
          ...
          <a
            href="#"
            class="steps-content"
            @click.prevent="currentStep >= 1 && scrollTo('#form-step-1', 800, { offset: -150 })"
          >
        ...
        <li :class="[currentStep === 2 && 'is-active']" class="steps-segment">
          ...
          <a
            href="#"
            class="steps-content"
            @click.prevent="currentStep >= 2 && scrollTo('#form-step-2', 800, { offset: -150 })"
          >
        ...
        <li :class="[currentStep === 3 && 'is-active']" class="steps-segment">
          ...
          <a
            href="#"
            class="steps-content"
            @click.prevent="currentStep >= 3 && scrollTo('#form-step-3', 800, { offset: -150 })"
          >
        ...
        <li :class="[currentStep === 4 && 'is-active']" class="steps-segment">
          ...
          <a
            href="#"
            class="steps-content"
            @click.prevent="currentStep >= 4 && scrollTo('#form-step-4', 800, { offset: -150 })"
          >
      ...
      <div class="form-sections">
        <div v-if="currentStep >= 0" id="form-step-0" class="form-section is-active">
          <h3 class="form-section-title">
            ...
            <button class="help-button" @click="currentHelp === 0 ? (currentHelp = -1) : (currentHelp = 0)">
          ...
          <div class="form-section-inner">
            <VField>
              <VControl>
                <input type="text" class="input" placeholder="What is this shipment about?" />
              </VControl>
            </VField>
            ...
            <div class="fieldset">
              ...
              <VField>
                ...
                <VControl>
                  <input type="text" class="input" placeholder="Add some additional notes" />
                </VControl>
              </VField>
              ...
              <VField>
                ...
                <VControl>
                  <Multiselect
                    v-model="storageType"
                    :options="['LVL 1 Security warehouse', 'LVL 2 Security warehouse', 'LVL 3 Security warehouse']"
              ...
              <VField>
                ...
                <VControl>
                  <input type="number" class="input" placeholder="Enter a storage duration" />
                </VControl>
              </VField>
        ...
        <transition name="fade-slow">
          <div v-if="currentStep >= 1" id="form-step-1" class="form-section is-active">
            <h3 class="form-section-title">
              ...
              <button class="help-button" @click="currentHelp === 1 ? (currentHelp = -1) : (currentHelp = 1)">
                <i aria-hidden="true" class="iconify" data-icon="feather:help-circle"></i>
              </button>
            </h3>
        ...
        <transition name="fade-slow">
          <div v-if="currentStep >= 2" id="form-step-2" class="form-section is-active">
            <h3 class="form-section-title">
              ...
              <button class="help-button" @click="currentHelp === 2 ? (currentHelp = -1) : (currentHelp = 2)">
                <i aria-hidden="true" class="iconify" data-icon="feather:help-circle"></i>
              </button>
            </h3>
        ...
        <transition name="fade-slow">
          <div v-if="currentStep >= 3" id="form-step-3" class="form-section is-active">
            <h3 class="form-section-title">
              <span>Options</span>
              <button class="help-button" @click="currentHelp === 3 ? (currentHelp = -1) : (currentHelp = 3)">
                <i aria-hidden="true" class="iconify" data-icon="feather:help-circle"></i>
              </button>
            </h3>
        ...
        <transition name="fade-slow">
          <div v-if="currentStep >= 4" id="form-step-4" class="form-section is-active">
            <h3 class="form-section-title">
              ...
              <button class="help-button" @click="currentHelp === 4 ? (currentHelp = -1) : (currentHelp = 4)">
                <i aria-hidden="true" class="iconify" data-icon="feather:help-circle"></i>
              </button>
            </h3>
            <div class="form-section-inner">
              <div class="validation-box">
                <div class="box-content">
                  <h3>Excellent</h3>
                  <p>
                    Before submitting the form, make sure you've filled all the required fields. Once submitted, you
                    won't be able to change the info for this shipment.
                  </p>
                </div>
        ...
        <div class="navigation-buttons">
          <div class="buttons is-right">
            <VButton color="primary" bold :loading="isLoading" @click="validateStep"> Continue </VButton>
          </div>
        </div>
      </div>
      <div class="form-stepper">
        <ul v-if="currentHelp === -1" class="steps is-vertical is-thin is-short">
          ...
          <li
            ...
            class="steps-segment"
            @click.prevent="currentStep >= 3 && scrollTo('#form-step-3', 800, { offset: -20 })"
          >
            <a href="#" class="steps-marker"></a>
            <div class="steps-content">
              <p class="step-number">STEP 4</p>
          ...
          <li
            ...
            class="steps-segment"
            @click.prevent="currentStep >= 4 && scrollTo('#form-step-4', 800, { offset: -20 })"
          >
            <a href="#" class="steps-marker"></a>
            <div class="steps-content">
              <p class="step-number">STEP 5</p>
        ...
        <div v-else class="form-help">
          <div v-if="currentHelp === 0" id="help-section-0" class="form-help-inner is-active">
            ...
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed quod proximum fuit non vidit. Quantum
              Aristoxeni ingenium consumptum videmus in musicis? An eiusdem modi? Quae similitudo in genere etiam humano
              apparet.
            </p>
            <div class="list-wrap">
              <ul>
          ...
          <div v-if="currentHelp === 1" id="help-section-1" class="form-help-inner is-active">
            ...
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed quod proximum fuit non vidit. Quantum
              Aristoxeni ingenium consumptum videmus in musicis? An eiusdem modi? Quae similitudo in genere.
            </p>
            <div class="list-wrap">
              <ul>
                <li>

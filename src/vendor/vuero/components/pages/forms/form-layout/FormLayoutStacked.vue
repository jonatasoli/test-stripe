      ...
      <div class="form-body">
        <div class="form-section">
          <div class="columns is-multiline">
            <div class="column is-12">
              <v-field>
                <v-control icon="feather:slack">
                  <input type="text" class="input" placeholder="What is this meeting about?" />
                </v-control>
              </v-field>
            </div>

            <v-date-picker v-model="date" is-range color="green" trim-weeks class="column is-6">
            ...
            <v-date-picker v-model="date.start" class="column is-3" color="green" mode="time" is24hr>
              <template #default="{ inputValue, inputEvents }">
                <v-field>
                  <label>Meeting time</label>
                  <v-control>
                    <input class="input form-timepicker" :value="inputValue" v-on="inputEvents" />
                  </v-control>
                </v-field>
              </template>
            </v-date-picker>

            <v-date-picker v-model="date.end" class="column is-3" color="green" mode="time" is24hr>
              <template #default="{ inputValue, inputEvents }">
                <v-field>
          ...
          <div class="form-section-inner is-horizontal">
                  ...
                  <v-control>
                    <div class="participants">
                      <tippy class="has-help-cursor" interactive placement="top-start">
                        <v-avatar picture="/images/avatars/svg/vuero-1.svg" />
                        <template #content>
                          <user-popover-content :user="popovers.user8" />
                        </template>
                      </tippy>
                      ...
                      <tippy class="has-help-cursor" interactive placement="top-start">
                        ...
                        <template #content>
                          <user-popover-content :user="popovers.user122" />
                        </template>
                      </tippy>
                      ...
                      <tippy class="has-help-cursor" interactive placement="top-start">
                        ...
                        <template #content>
                          <user-popover-content :user="popovers.user18" />
                        </template>
                      </tippy>
                      ...
                      <tippy class="has-help-cursor" interactive placement="top-start">
                        ...
                        <template #content>
                          <user-popover-content :user="popovers.user123" />
                        </template>
                      </tippy>
                      ...
                      <tippy class="has-help-cursor" interactive placement="top-start">
                        ...
                        <template #content>
                          <user-popover-content :user="popovers.user7" />
                        </template>
                      </tippy>
            ...
            <div class="field is-horizontal">
              ...
              <div class="field-body">
                <v-field>
                  <v-control icon="feather:map-pin">
                    <input class="input" type="url" placeholder="https://zoom.com/m/156546" inputmode="url" />
                  </v-control>
                </v-field>
              </div>
            </div>
                    ...
                    <multiselect
                      ...
                      :options="[
                        ...
                        },
                        {
                          name: 'Erik K.',
                          value: 'eric',
                          icon: '/images/avatars/svg/vendor-1.svg'
                        },
                        {
                          name: 'Joshua S.',
                          value: 'joshua',

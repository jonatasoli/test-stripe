      ...
      <div class="fieldset">
        ...
        <div class="columns is-multiline">
          ...
          <div class="column is-12">
            <VField>
              <VControl icon="feather:unlock">
                <input type="password" class="input" placeholder="Old Password" autocomplete="current-password" />
              </VControl>
            </VField>
          </div>
          <!--Field-->
          <div class="column is-12">
            <VField>
              <VControl icon="feather:lock">
                <input type="password" class="input" placeholder="New Password" autocomplete="new-password" />
              </VControl>
            </VField>
          </div>
          <!--Field-->
          <div class="column is-12">
            <VField>
              <VControl icon="feather:lock">
                <input type="password" class="input" placeholder="Repeat New Password" autocomplete="new-password" />
              </VControl>
            </VField>
          </div>
        </div>
          ...
          <div v-if="twoFactor" class="column is-12">
            <VField>
              <VControl icon="feather:smartphone">
                <input type="text" class="input" placeholder="Phone Number" autocomplete="tel" inputmode="tel" />
              </VControl>
            </VField>
          </div>
        </div>

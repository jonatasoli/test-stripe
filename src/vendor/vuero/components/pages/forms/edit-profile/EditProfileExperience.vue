        ...
        <div class="setting-list">
            ...
            <div class="field-wrap">
              <div class="columns is-multiline">
                ...
                <div class="column is-6">
                  <VField>
                    <VControl icon="feather:box">
                      <input type="text" class="input" placeholder="Company Name" autocomplete="organization" />
                    </VControl>
                  </VField>
                </div>
                <div class="column is-6">
                ...
                <div class="column is-12">
                  <VField>
                    <VControl>
                      <VButton color="primary" raised fullwidth> Add Work Experience </VButton>
                    </VControl>
                  </VField>
                </div>
              </div>
          ...
          <template v-else>
            ...
            <div class="setting-item is-create">
              ...
              <div class="end">
                <VButton raised dark-outlined icon="fas fa-plus" class="add-setting-item" @click="isUploading = true">
                  Add
                </VButton>
              </div>
            </div>

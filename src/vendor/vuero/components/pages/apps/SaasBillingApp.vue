      ...
      <div class="left">
        ...
        <div class="option-block">
          ...
          <div class="block-body">
            <VSwitchBlock v-model="invoces" label="Send new invoices to my inbox" color="primary" />
            <VSwitchBlock v-model="warnBilling" label="Warn me before the end of the billing period" color="primary" />
          </div>
        </div>
            ...
            <div class="columns is-multiline">
              ...
              <div class="column is-12">
                <VField>
                  ...
                  <VControl>
                    ...
                    />
                    <!-- eslint-disable vue/no-v-html -->
                    <div id="creditcardIcon" class="creditcardIcon" v-html="creditcardIcon"></div>
                    <!-- eslint-enable vue/no-v-html -->
                  </VControl>
                </VField>
              </div>
              ...
              <div class="column is-12">
                <div class="button-wrap">
                  <VButton color="primary" raised fullwidth> Save Payment Method </VButton>
                </div>
              </div>
            </div>
          </div>

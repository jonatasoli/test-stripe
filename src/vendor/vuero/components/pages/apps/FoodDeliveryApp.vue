        ...
        <div class="restaurants">
          ...
          <div class="restaurants-list">
            <div class="columns is-multiline">
              <!--Restaurants Loop-->
              <div v-for="restaurant in foodDelivery.restaurants" :key="restaurant.id" class="column is-4">
                  ...
                  <div class="meta-container">
                    <div class="meta-icon">
                      <img
                        :src="restaurant.icon"
                        alt=""
                        @error.once="event => useViaPlaceholderError(event, '                            ')"
                      />
                    </div>
        ...
        <div class="widget icon-toolbar-widget">
          <div class="icon-toolbar">
            <div class="toolbar-icon">
              <a class="inner-icon" :class="[activeSection === 'cart' && 'is-active']" @click="activeSection = 'cart'">

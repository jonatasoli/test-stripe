...
<template>
  <div class="page-content kanban-content is-relative">
    ...
    <div class="columns is-kanban-wrapper">
      <!-- Column container -->
      <div class="column" :class="[isColumnNewCollapsed && 'is-1 is-mini', !isColumnNewCollapsed && 'is-one-fifth']">
        <!-- Kanban column -->
        <div
          class="kanban-column"
          :class="[isColumnNewCollapsed && 'is-collapsed', newTasks.length === 0 && 'is-empty']"
        >
          <!-- Collapsed content -->
          ...
          <div class="expanded-content">
            ...
            <div ref="newContainer" data-state="new">
              ...
              <div v-for="task in newTasks" :key="task.id" :data-id="task.id" class="kanban-card is-new">
                <div class="card-body">
                  <h4 class="card-title">
                    {{ task.title }}
                  </h4>
                ...
                <footer class="card-footer">
                  ...
                  <a class="card-footer-item" @click="task.state = 'progress'"> Approve </a>
                </footer>
              </div>
            </div>
          </div>
      ...
      >
        <div
          ...
          :class="[isColumnProgressCollapsed && 'is-collapsed', progressTasks.length === 0 && 'is-empty']"
        >
          <!-- Collapsed content -->
          <div class="collapsed-content">
          ...
          <div class="expanded-content">
            ...
            <div ref="progressContainer" data-state="progress">
              ...
              <div v-for="task in progressTasks" :key="task.id" class="kanban-card gelatine" :data-id="task.id">
                <div class="card-body">
      ...
      <div
        class="column"
        :class="[isColumnReadyCollapsed && 'is-1 is-mini', !isColumnReadyCollapsed && 'is-one-fifth']"
      >
        <div
          class="kanban-column can-drag"
          :class="[isColumnReadyCollapsed && 'is-collapsed', readyTasks.length === 0 && 'is-empty']"
        >
          <!-- Collapsed content -->
          <div class="collapsed-content">
            ...
            <div ref="readyContainer" data-state="ready">
              <div v-if="readyTasks.length === 0" class="kanban-empty">
                ...
                <p class="empty-text">
                  ...
                  <a href="#" class="button v-button is-outlined is-rounded is-fullwidth"> Create Task </a>
                </p>
              </div>

              <div v-for="task in readyTasks" :key="task.id" :data-id="task.id" class="kanban-card gelatine">
                <div class="card-body">
                  <h4 class="card-title">{{ task.title }}</h4>
                  <div class="kanban-card-stats">
                    <span>
      ...
      <div
        class="column"
        :class="[isColumnReviewCollapsed && 'is-1 is-mini', !isColumnReviewCollapsed && 'is-one-fifth']"
      >
        <div
          class="kanban-column can-drag"
          :class="[isColumnReviewCollapsed && 'is-collapsed', reviewTasks.length === 0 && 'is-empty']"
        >
          <!-- Collapsed content -->
          <div class="collapsed-content">
          ...
          <div class="expanded-content">
            ...
            <div ref="reviewContainer" data-state="review">
              ...
              <div v-for="task in reviewTasks" :key="task.id" :data-id="task.id" class="kanban-card gelatine">
                <div class="card-body">
                  <h4 class="card-title">{{ task.title }}</h4>
                  <div class="kanban-card-stats">
                    <span>
      ...
      >
        <div
          class="kanban-column"
          :class="[isColumnCompletedCollapsed && 'is-collapsed', completedTasks.length === 0 && 'is-empty']"
        >
          <!-- Collapsed content -->
          <div class="collapsed-content">
          ...
          <div class="expanded-content">
            ...
            <div ref="completedContainer" data-state="completed">
              ...
              <div v-for="task in completedTasks" :key="task.id" :data-id="task.id" class="kanban-card gelatine">
                <div class="card-body">
                  <h4 class="card-title">{{ task.title }}</h4>
                  <div class="kanban-card-stats">
                    <span>
